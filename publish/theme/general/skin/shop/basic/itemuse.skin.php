...
<section id="sit_use_list">
	<h3>Registered product reviews</h3>
	...
	<div class="sit_use_top">
		...
		There are <strong><?php echo $total_count; ?></strong> Reviews
		<?php } ?>
		<div id="sit_use_wbtn">
			<a href="<?php echo $itemuse_form; ?>" class="btn02 itemuse_form">Write Reviews<span class="sound_only"> New window</span></a>
			<a href="<?php echo $itemuse_list; ?>" class="btn01 itemuse_list">View more</a>
		</div>
	</div>
	<?php
	$thumbnail_width = 500;
	...
	?>
		...
		<li class="sit_use_li">
				...
				<button type="button" class="sit_use_li_title">View content <i class="fa fa-caret-down" aria-hidden="true"></i></button>
				<dl class="sit_use_dl">
					<dt>Grade<dt>
			...
			<div id="sit_use_con_<?php echo $i; ?>" class="sit_use_con">
				...
				<div class="sit_use_cmd">
					<a href="<?php echo $itemuse_form."&amp;is_id={$row['is_id']}&amp;w=u"; ?>" class="itemuse_form btn01" onclick="return false;">Edit</a>
					<a href="<?php echo $itemuse_formupdate."&amp;is_id={$row['is_id']}&amp;w=d&amp;hash={$hash}"; ?>" class="itemuse_delete btn01">Delete</a>
				</div>
				<?php } ?>

				<?php if( $is_reply_subject ){  //  사용후기 답변 내용이 있다면 ?>
				<div class="sit_use_reply">
					<div class="use_reply_icon">answer</div>
