...
?>
 <div id="register_form"  class="form_01">   
	<div>
		...
		<ul>
			<li>
				<label for="reg_mb_id" class="sound_only">ID<strong>Necessary</strong></label>
			...
			<li>
				<label for="reg_mb_password" class="sound_only">Password<strong class="sound_only">Necessary</strong></label>
				...
				<label for="reg_mb_password_re" class="sound_only">Password confirm<strong>Necessary</strong></label>
				<input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="frm_input half_input right_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="Password confirm">
			</li>
		</ul>
	</div>
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<ul>
			<li>
				<label for="reg_mb_name" class="sound_only">Name<strong>Necessary</strong></label>
			...
			<?php if ($req_nick) {  ?>
			<li>
				<label for="reg_mb_nick" class="sound_only">Nic name<strong>Necessary</strong></label>
				
					<input type="hidden" name="mb_nick_default" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>">
					<input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace  half_input" size="10" maxlength="20" placeholder="Nic name">
			...
			<li>
				<label for="reg_mb_email" class="sound_only">E-mail<strong>Necessary</strong></label>
			...
			<li>
				<label for="reg_mb_homepage" class="sound_only">Homepage<?php if ($config['cf_req_homepage']){ ?><strong>Necessary</strong><?php } ?></label>
			...
			<?php if ($config['cf_use_tel']) {  ?>
				...
				<label for="reg_mb_tel" class="sound_only">Phone No.<?php if ($config['cf_req_tel']) { ?><strong>Necessary</strong><?php } ?></label>
				<input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" <?php echo $config['cf_req_tel']?"required":""; ?> class="frm_input half_input <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" placeholder="Phone No.">
			<?php }  ?>

			<?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
				<label for="reg_mb_hp" class="sound_only">Cell phone No.<?php if ($config['cf_req_hp']) { ?><strong>Necessary</strong><?php } ?></label>
				
				<input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input right_input half_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20" placeholder="Cell phone No.">
			...
			<li>
				...
				<label for="reg_mb_addr1" class="sound_only">Address 1<?php echo $config['cf_req_addr']?'<strong> Necessary</strong>':''; ?></label>
				<input type="text" name="mb_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr']?"required":""; ?> class="frm_input frm_address full_input <?php echo $config['cf_req_addr']?"required":""; ?>" size="50"  placeholder="Address 1">
				<br>
				<label for="reg_mb_addr2" class="sound_only">Address 2</label>
				<input type="text" name="mb_addr2" value="<?php echo get_text($member['mb_addr2']) ?>" id="reg_mb_addr2" class="frm_input frm_address full_input" size="50"  placeholder="Address 2">
				<br>
				<label for="reg_mb_addr3" class="sound_only">City</label>
				<input type="text" name="mb_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="reg_mb_addr3" class="frm_input frm_address full_input" size="50" placeholder="City">
				<br>
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<ul>
			...
			<li>
				<label for="reg_mb_signature" class="sound_only">서명<?php if ($config['cf_req_signature']){ ?><strong>Necessary</strong><?php } ?></label>
