...
CREATE TABLE IF NOT EXISTS `g5_shop_order` (
  ...
  `od_addr4` varchar(255) NOT NULL DEFAULT '',
  `od_addr_country` varchar(255) NOT NULL DEFAULT '',
  ...
  `od_b_addr4` varchar(255) NOT NULL DEFAULT '',
  `od_b_addr_country` varchar(255) NOT NULL DEFAULT '',
  ...
  `od_invoice_time` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `g5_shop_order_address` (
  ...
  `ad_addr4` varchar(255) NOT NULL DEFAULT '',
  `ad_addr_country` varchar(255) NOT NULL DEFAULT '',
