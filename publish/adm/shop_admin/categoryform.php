	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row"><label for="ca_21">카테고리 메뉴 숨김처리</label></th>
					<td>
						<input type="radio" name="ca_2" value="0" id="ca_21"<?php echo ($ca['ca_2'] == '' || $ca['ca_2'] == '0') ? "checked": ""; ?>> 보이기
						<input type="radio" name="ca_2" value="1" id="ca_22"<?php echo ($ca['ca_2'] == '1') ? "checked": ""; ?>> 숨기기
					</td>
				</tr>
				<tr>
...
<section>
	<div class="icon-type">
		<?php
		if($ca['ca_1'] != '' && $ca['ca_1_subj'] == 'img-icon') {
			$is_icon_file = G5_DATA_PATH.'/cate-nav-icon/'.$ca['ca_1'];
		...
		<input type="text" name="" id="iconName" value="" class="frm_input">
		<?php
		if (is_file($is_icon_file) && $ca['ca_1_subj'] == 'img-icon'):
		?>
		<span>
			<input type="checkbox" name="icon_del" id="icon_del">
			<label for="icon_del">
				<img src="<?php echo G5_DATA_URL.'/cate-nav-icon/'.$ca['ca_1']; ?>" alt="delete image">
				삭제
			</label>
		</span>
		<?php
